...
function SignUpSection() {
    return ( 
        <>
            <form action="" className="sm:p-20 p-4 min-h-screen">
                <div>
                    <h1 className="text-4xl text-center font-semibold">REGISTRATION FORM</h1>
                    <div className="mt-16 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-6">
